...
const Home = () => {
  return (
    <div className="homes">
      <h1>Welcome to the Financial Planning Tool</h1>
      <p>Start managing your budget and expenses!</p>
      <div className='title'>
        <p className="name">by Vanessa Pitchford Cristobal</p>
      </div>
      <svg className="container" width="529px" height="286px" viewBox="30 27 529 286" version="1.1" xmlns="http://www.w3.org/2000/svg">
        {/* <!-- Generator: Sketch 3.8.3 (29802) - http://www.bohemiancoding.com/sketch --> */}
        <desc>Created with Sketch.</desc>
        <defs></defs>
        <g id="graph-copy" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" transform="translate(30.000000, 27.000000)">
          <g id="y_axis" fontSize="11.0833333" fontFamily=".HelveticaNeueDeskInterface-Regular, .Helvetica Neue DeskInterface" fill="#FFFFFF" opacity="0.4" fontWeight="normal">
            <text id="0">
          ...
          <g id="GRAPHS" transform="translate(64.000000, 16.000000)" strokeLinecap="round" strokeWidth="8" strokeLinejoin="round">
          ...
          <g id="x_axis" transform="translate(71.974046, 271.541667)" fontSize="11.0833333" fontFamily=".HelveticaNeueDeskInterface-Regular, .Helvetica Neue DeskInterface" fill="#FFFFFF" opacity="0.4" fontWeight="normal">
            <text id="1"><tspan x="0.396183206" y="11">1</tspan></text>
            <text id="2"><tspan x="39.2603361" y="11">2</tspan></text>
            <text id="3"><tspan x="78.8786567" y="11">3</tspan></text>
            <text id="4"><tspan x="118.496977" y="11">4</tspan></text>
            <text id="5"><tspan x="158.115298" y="11">5</tspan></text>
            <text id="6"><tspan x="197.733619" y="11">6</tspan></text>
            <text id="7"><tspan x="237.351939" y="11">7</tspan></text>
            <text id="8"><tspan x="276.97026" y="11">8</tspan></text>
            <text id="9"><tspan x="316.58858" y="11">9</tspan></text>
            <text id="10"><tspan x="359.229833" y="11">10</tspan></text>
            <text id="11"><tspan x="400.036703" y="11">11</tspan></text>
            <text id="12"><tspan x="438.466474" y="11">12</tspan></text>
          </g>
          <g id="grid" transform="translate(46.618321, 4.750000)" stroke="#FFFFFF" strokeLinecap="square" opacity="0.08">
